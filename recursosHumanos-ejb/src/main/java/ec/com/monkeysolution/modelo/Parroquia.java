...
@NamedQueries({
    ...
    , @NamedQuery(name = "Parroquia.findByFechaCr", query = "SELECT p FROM Parroquia p WHERE p.fechaCr = :fechaCr")
    , @NamedQuery(name = "Parroquia.findByFechaAct", query = "SELECT p FROM Parroquia p WHERE p.fechaAct = :fechaAct")
    , @NamedQuery(name = "Parroquia.findByUsuarioCr", query = "SELECT p FROM Parroquia p WHERE p.usuarioCr = :usuarioCr")
    , @NamedQuery(name = "Parroquia.findByUsuarioAct", query = "SELECT p FROM Parroquia p WHERE p.usuarioAct = :usuarioAct")})
public class Parroquia implements Serializable {
    ...
    public Parroquia(Integer id, String nombre, String estado, Date fechaCr, int usuarioCr) {
        this.id = id;
        this.nombre = nombre;
        this.estado = estado;
    ...
    public String toString() {
        return "ec.com.monkeysolution.modelo.Parroquia[ id=" + id + " ]";
    }
